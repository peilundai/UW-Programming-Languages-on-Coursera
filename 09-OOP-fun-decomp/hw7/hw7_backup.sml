...
fun intersect (v1,v2) =
  case (v1,v2) of
    ...
    (* 2. [Point] in first position cases *)
    ...
    (* 3. [Line] in first position cases *)
    ...
    (* 4. [VerticalLine] in first position cases *)
    ...
    (* 5. [LineSegment] in first position cases *)
...
fun eval_prog (e,env) =
  case e of
    ...
    | Shift(deltaX, deltaY, e0) => 
        let 
          val result = eval_prog (e0, env)
        in 
          case result of 
              NoPoints => NoPoints
            ...
            | _ => raise BadProgram("Evaluation is not of e is not a value type")
        end 
